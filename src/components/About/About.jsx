...
const About = () => {
    return (
        <>
            <div className=" bg-sky-50 shadow-sm p-8"><h1 className="text-[3rem] text-center my-4  text-blue-500 font-mono">NextZenTech <span className="text-[2rem] text-black">About Mission And Story</span></h1>
            ...
            <div className=" shadow-lg mt-[6rem] p-4"><h1 className="text-center text-[3rem] font-mono">Our Values</h1>
