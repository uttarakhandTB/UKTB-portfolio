...
import { FaFacebook, FaInstagram, FaLinkedinIn,  FaMailBulk,  FaTwitter, FaWhatsapp } from "react-icons/fa"
      ...
      <footer className=" mt-auto bg-white   pt-3    bg-[url('src/assets/images/footer-bg.png')] ">
        <div className="mx-20 flex row " >
          <div className="w-[] col-lg-6 col-md-12">
            ...
            <FaMailBulk className="mx-2 text-[25px] hover:-translate-y-2 hover:text-blue-800 cursor-pointer transtion-all ease-in-out duration-500 "/>
            </div>
          </div>
